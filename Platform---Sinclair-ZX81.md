...
*  g007: default clib, G007 HRG mode (requires the HRG being set up from BASIC:  CLS 2 / SLOW 4, probably [disabling the autorun on appmake](#disabling-autorun) will help)
